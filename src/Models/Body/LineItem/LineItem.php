...
use DazzaDev\DgiiJsonGenerator\Models\Base\DonationType;
use DazzaDev\DgiiJsonGenerator\Models\Body\Tax\Tax;
use DazzaDev\DgiiJsonGenerator\Traits\ItemTypeTrait;
use DazzaDev\DgiiJsonGenerator\Traits\TaxTrait;
...
class LineItem
{
     ...
     */
    private float $depreciation = 0.0;
    ...
    private function initialize(array $data): void
    {
        ...
        if (isset($data['donation_type'])) {
            $this->setDonationType((int) $data['donation_type']);
        }
        ...
        if (isset($data['total_value'])) {
            $this->setTotalValue((float) $data['total_value']);
        }
        ...
        if (isset($data['depreciation'])) {
            $this->setDepreciation((float) $data['depreciation']);
        }
    }
     ...
     */
    public function getDonationTypeCode(): ?int
    {
        $code = $this->getDonationType()?->getCode();
     ...
     * Set donation type
     */
    public function setDonationType(int $donationTypeCode): void
    {
        $donationType = (new DataLoader('tipos-donacion'))->getByCode($donationTypeCode);

        $this->donationType = new DonationType($donationType);
    }
     ...
     * Set depreciation
     */
    public function setDepreciation(float $depreciation): void
    {
