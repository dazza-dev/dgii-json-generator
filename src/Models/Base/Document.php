...
use DazzaDev\DgiiJsonGenerator\Models\Body\AdditionalInfo;
use DazzaDev\DgiiJsonGenerator\Models\Body\Extension\Extension;
use DazzaDev\DgiiJsonGenerator\Models\Body\LineItem\LineItem;
use DazzaDev\DgiiJsonGenerator\Models\Body\OtherDocument\OtherDocument;
use DazzaDev\DgiiJsonGenerator\Models\Body\Payment\Payment;
use DazzaDev\DgiiJsonGenerator\Models\Body\RelatedDocument;
use DazzaDev\DgiiJsonGenerator\Models\Body\Summary;
use DazzaDev\DgiiJsonGenerator\Models\Body\ThirdPartySale;
use DazzaDev\DgiiJsonGenerator\Traits\ContingencyTypeTrait;
use DazzaDev\DgiiJsonGenerator\Traits\DocumentTypeTrait;
use DazzaDev\DgiiJsonGenerator\Traits\IssuerTrait;
use DazzaDev\DgiiJsonGenerator\Traits\ReceiverTrait;
...
class Document extends DTEModel
{
    ...
    private function initialize(array $data): void
    {
        ...
        if (isset($data['contingency'])) {
            $this->setContingency($data['contingency']);
        }
